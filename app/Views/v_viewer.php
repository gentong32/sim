...
<head>
    ...
    <script src="pdfThumbnails.js" data-pdfjs-src="/js/pdf.js"></script>
    <style>
...
<body>
    ...
    <div class="container" id="maincontent">
        <div class="row">
            <div class="col-lg-12">
                ...
                <p>PDF Thumbnails is a small script to parse html files and generate a source image for `img` elements
                    ...
                    Here is the <a href="/assets/pdf/example.pdf">example pdf</a> used for the thumbnails of this page.
                </p>
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <h4>col-sm-6</h4>
                <a href="/assets/pdf/example.pdf">
                    <img class="img-responsive" data-pdf-thumbnail-file="/assets/pdf/example.pdf" src="pdf.png">
                </a>
            </div>
            <div class="col-sm-3">
                <h4>col-sm-3</h4>
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                ...
                <a href="/assets/pdf/example.pdf">
                    <img data-pdf-thumbnail-file="/assets/pdf/example.pdf" data-pdf-thumbnail-width="200" width="200" src="pdf.png">
                </a>
            </div>
            <div class="col-sm-4">
                <h4>data-pdf-thumbnail-height="200"</h4>
                <a href="/assets/pdf/example.pdf">
                    <img data-pdf-thumbnail-file="/assets/pdf/example.pdf" data-pdf-thumbnail-height="200" height="200" src="pdf.png">
                </a>
            </div>
            <div class="col-sm-4">
                <h4>data-pdf-thumbnail-width="200" AND data-pdf-thumbnail-height="200"</h4>
                <a href="/assets/pdf/example.pdf">
                    <img data-pdf-thumbnail-file="/assets/pdf/example.pdf" data-pdf-thumbnail-width="200" data-pdf-thumbnail-height="200" width="200" src="pdf.png">
                </a>
            </div>
        </div>
