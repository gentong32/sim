...
<script>
    ...
    filterrombel(selectedKelas);

    document.getElementById('kelas').addEventListener('change', function() {
        filterrombel(this.value);
    });

    function filterrombel(selectedKelas) {
        let rombelOptions = rombelData.filter(data => data.kelas === selectedKelas);

        // Update elemen select rombel
        let rombelSelect = document.getElementById('rombel');
        rombelSelect.innerHTML = ''; // Bersihkan opsi sebelum menambah yang baru

        rombelOptions.forEach(rombel => {
            let option = document.createElement('option');
            option.value = rombel.nama_rombel;
            option.textContent = rombel.nama_rombel;
