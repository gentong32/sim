...
<div id="formContainer">
    <form action="<?= base_url("superadmin/simpan_kalender") ?>" method="post">
        <div class="formContent">
            <h5 id="judulinput">kalender Tanggal</h5>
            <div class="dinput">
                <label for="cprojek">kalender:</label>
                <input type="text" class="ckalender" id="ikalender" name="ikalender" \> <button id="tbhapus" class="hapus" onclick="return hapusInput()">X</button>
            </div>
    ...
    <form id="fhapus" action="<?= base_url("superadmin/hapus_kalender") ?>" method="post">
...
<div class="tanggalan">
    <div class="calendar-container">
        <div id="bulantahun"><button onclick="mundurmonth()">&lt;</button>
            <div id="monthyear"><span id="month"></span> <span id="year"></div></span><button onclick="majumonth()">&gt;</button>
        </div>
...
<script>
            ...
            for (let j = 0; j < 7; j++) {
                ...
                if (i === 0 && j < startDay) {
                    ...
                    cell.addEventListener('click', function() {
                        ...
                        document.getElementById('ikalender').value = cell.dataset.title;
                        tanggaledit = cell.dataset.tgl;
                        addedit = cell.dataset.addedit;
    ...
    function displayEventList(year, month) {
        ...
        combinedEvents.forEach((event, index) => {
            ...
            kalenderDiv.appendChild(entryDiv);
        });
    }
    ...
    function okInput() {
        ...
        if (document.getElementById('ikalender').value == "") {
    ...
    function hapusInput() {
        if (confirm("Apakah mau hapus kalender ini?")) {
    ...
    function lihatagenda() {
        window.open('<?= base_url("superadmin/list_kalender") ?>', '_self');
    }
</script>
