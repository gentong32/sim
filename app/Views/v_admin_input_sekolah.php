...
<div class="form-container">
    ...
    <div class="form-group">
        ...
        <input type="text" id="propinsi" name="propinsi" required>
    </div>

    <div class="form-group">
        <label for="telp"><i class="fas fa-user"></i>Telp Sekolah</label>
        <input type="text" id="telp_sekolah" name="telp_sekolah" required>
    </div>

    <div class="form-group">
        <label for="email_sekolah"><i class="fas fa-envelope"></i>Email Sekolah</label>
        <input type="email" id="email_sekolah" name="email_sekolah" required>
    ...
    <div class="form-group">
        ...
        <input type="text" id="alamat_admin" name="alamat_admin" required>
    </div>
    <div class="form-group">
        <label for="no_hp"><i class="fas fa-user"></i>No. HP Admin</label>
        <input type="text" id="telp_admin" name="telp_admin" required>
    </div>
    <div class="form-group">
