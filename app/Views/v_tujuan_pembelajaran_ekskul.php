...
<script>
    ...
    function oktj_pem(button, baris) {
        ...
        if (addedit == "add") {
            var url = '<?= base_url() . "tujuan_pembelajaran/simpan_tj_pem_eks" ?>';
            var data = {
                valkelas: '<?= $valkelas ?>',
            ...
            var url = '<?= base_url() . "tujuan_pembelajaran/update_tj_pem_eks" ?>';
            var data = {
                valkelas: '<?= $valkelas ?>',
                kelasdipilih: kelasdipilih,
                tj_pem: cellContent,
    ...
    function hapustj_pem(button, baris) {
        if (confirm("Yakin mau menghapus tujuan pembelajaran ini?")) {
            var row = button.parentElement.parentElement;
            var cell = row.querySelector('.editable');
            var cellContent = cell.textContent;
            var url = '<?= base_url() . "tujuan_pembelajaran/hapus_tj_pem_eks" ?>';
            var data = {
                valkelas: '<?= $valkelas ?>',
                kelasdipilih: kelasdipilih,
                tj_pem: cellContent,
