...
<div id="formContainer">
    <form action="<?= base_url("admin/simpan_agenda") ?>" method="post">
        <div class="formContent">
            ...
            <div class="dinput">
                <label for="cprojek">Jenis:</label>
                <select name="ipilih" id="ipilih">
            ...
            <div class="dinput">
                ...
                <input type="text" class="cagenda" id="iagenda" name="iagenda" \> <button id="tbhapus" class="hapus" onclick="return hapusInput()">X</button>
            </div>
    ...
    <form id="fhapus" action="<?= base_url("admin/hapus_agenda") ?>" method="post">
...
<div class="tanggalan">
    <div class="calendar-container">
        ...
        <?php if ($jmldataagenda < 3) { ?>
            <div class="info-sementara">
                * Klik pada tanggal untuk menambahkan agenda / kegiatan
            </div>
        <?php } ?>
